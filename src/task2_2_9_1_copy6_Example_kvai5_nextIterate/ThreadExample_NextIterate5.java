...
public class ThreadExample_NextIterate5 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        new ThreadExample_NextIterate5.MyThread4_5().start();
        new ThreadExample_NextIterate5.MyThread7_5().start();
    }

    static class MyThread4_5 extends Thread {
        int count = 0;
...
//                            throw new RuntimeException(e);
    ...
    static class MyThread7_5 extends Thread {
        @Override
        public void run() {
            synchronized (strings) {
