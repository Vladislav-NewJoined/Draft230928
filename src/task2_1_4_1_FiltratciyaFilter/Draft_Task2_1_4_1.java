...
public class Draft_Task2_1_4_1 {
    public static void main(String[] args) {
        System.out.println("""
                ...
                Урок 4. Фильтрация (filter), перебор (forEach), Сортировка (sort).
                    ...
                    Задание: Попробуйте создать поток рандомных чисел от -10  до 10,отфильтруйте их так, чтобы остались только положительные,
                    отсортируйте по возрастанию и выведите их  в консоль.
