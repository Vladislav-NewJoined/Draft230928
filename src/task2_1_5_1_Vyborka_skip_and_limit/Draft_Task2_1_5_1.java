package task2_1_5_1_Vyborka_skip_and_limit;

import java.util.ArrayList;

public class Draft_Task2_1_5_1 {
    public static void main(String[] args) {
        System.out.println("""
                Задание:\s
                Урок 5. Выборка (skip and limit).
                    Задание: У вас есть список моделей смартфонов, iPhone 6 S", "Lumia 950", "Samsung Galaxy S 6", 
                    "LG G 4", "Nexus 7", вам нужно вывести в консоль названия двух моделей пропустив при этом первый бренд при помощи метода skip и limit.
